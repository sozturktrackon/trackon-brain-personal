...
- **✅ Phase 2 ACCEPTED 2026-09-08** — Justin in writing ("Good to proceed with phase 2 proposal. Please send over the invoice."), replying to Murat's Sep-7 assumptive-close nudge; Josh cc'd. Four days past the Sep-4 validity date; price honored unchanged at $34,500 (validity was a schedule device, not a re-pricing trigger). **Invoice 1 to issue now: $13,800 (40% on acceptance).** Remaining: $13,800 at UAT start (~mid/late Nov), $6,900 at go-live (Dec). **Invoice hygiene (Phase-1 saga lesson): invoice + bank details in the exact name "Trackon Software FZCO" (the account title the Phase 1 payment cleared to); attach the FZCO W-8BEN-E and bank letter proactively; ask Justin to confirm DFA's vendor record reads FZCO, not DMCC.**
