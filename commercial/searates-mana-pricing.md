...
| **EVIDENCE** | SeaRates plan: $1,650/year prepaid for 1,500 unique shipments. Burned through in 3 months (Jan–Mar 2026). Cross-month double counting is the root cause. Mana active shipment pool: ~300 new/month × 3+ months active = ~500+ at any time. March 2026: credits exhausted, API_KEY_LIMIT_REACHED errors (Journey #21436 failed). SeaRates credited 28 emergency units. |
...
- Waiting for Josh to respond on WhatsApp
