...
| | |
|---|---|
| **THE PROBLEM** | Trackon provides vessel tracking to [[customers/mana/mana-overview|Mana Agro DMCC]] via SeaRates API. The current verbal agreement (EUR 500/month flat) is unsustainable — SeaRates credits burn 4x faster than expected because SeaRates counts unique shipments per calendar month, not per journey lifetime. A shipment active across 2 months = 2 credits. Mana voyages span 3–4 months (worsened by Red Sea situation), so the 1,500-shipment annual plan exhausts in 3 months instead of 12. Actual annual cost: $6,600 vs. EUR 6,000 revenue. How should we restructure billing to be margin-positive? |
