...
<div class="cover-sub">Five pages you can read on your phone. Where a business that buys in Dubai and sells in Africa actually loses money, and how one system puts a name on every transaction from the container to the shop shelf.</div>

<div class="cover-for">Prepared for Mr Shilpen · Spectrum DMCC</div>
...
<div class="eyebrow">3 · Dubai to Kinshasa</div>

# Every shop transaction with a name on it

<div class="body">Head office buys and ships. The depot receives. The shops accept stock, sell and spend. Each of those is a step, and each step has a name on it.</div>

<div class="card accent-blue"><div class="card-label">Receive stock</div><div class="card-text">The shop manager accepts the transfer with one tap on their own phone. The name, the time and the quantity are on the record. A shortage is visible the same day, not at stock count.</div></div>
<div class="card accent-blue"><div class="card-label">Sell</div><div class="card-text">Product, quantity, price, receipt. Every sale carries the staff member who made it and the landed cost of the item, so profit per shop and per product is real, not estimated.</div></div>
<div class="card accent-red"><div class="card-label">Record expenses</div><div class="card-text">Rent, transport, utilities, wages: recorded by the shop, approved by head office, landing on that shop's profitability. The same books head office runs on. No spreadsheets sent at month end.</div></div>


<div class="footer">Any Android or iPhone. Installs from a link. Each user sees only their own shop; head office sees all of them.</div>
...
<div class="num"><div class="badge">3</div><div class="t">One system from the purchase contract in Dubai to the receipt in the shop: landed cost per item, stock per shop, profit per shop, with the person behind every entry.</div></div>

<div class="slogan">Every step has a name on it.</div>

<div class="next"><div class="k">Next step</div>Your shop managers try the demo shop on their own phones this week: one stock receipt, one sale, one expense. Then we confirm the scope and the start date together.</div>
