...
- "Why Legacy and not TrackonAI?" "Legacy is the complete trading house in one system: contracts, shipments, treasury, GL, warehouse, FX, claims. TrackonAI is the logistics and contracting layer built to sit on an existing accounting system. You have no accounting system yet, so you need the whole house, not the top floor. AI assistant is on Legacy today; TrackonAI modules can be added as you grow." Do NOT volunteer this comparison, and do NOT use "soul" or the 911 vs Taycan line in the room (decided 2026-08-28): it reopens the UI and product-choice questions. Instead, at the first shipment screen: "Every field on this screen exists because a trader once lost money without it." 911 line: private, Turkish, with Fatih, after signature.
...
## POS and claims (decided 2026-08-28 evening)
